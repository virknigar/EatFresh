...
<div class="form-group col-md-4">
    <div class="well">
        ...
        <form action="customer_login_action.php" method="get">
        ...
        <a href="customer_create_account.php">Need an account?</a>
<!--
        <a href="customer_forgot_password.php"style="float:right">Forgot password?</a>
-->
    </div>
</div>
</body>
